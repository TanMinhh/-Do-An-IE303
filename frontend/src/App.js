...
import ChatbotTest from './component/chat/chatbot';
import ChatbotBubble from './component/chat/Bubble';
import ChatbotPopup from "./component/chat/chat";
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="App">
        ...
        <FooterComponent />
        <ChatbotBubble onClick={() => setShowChatbot(true)} />
