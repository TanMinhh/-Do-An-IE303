  ...
  return (
    <div className="room-details-booking">
      ...
      <div className="booking-info">
        { showDatePicker ? null : <button className="book-now-button" onClick={() => setShowDatePicker(true)}>Book Now</button>}
        { showDatePicker ? <button className="go-back-button" onClick={() => setShowDatePicker(false)}>Go Back</button> : null}
        {showDatePicker && (
